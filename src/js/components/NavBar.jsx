            ...
            <div className="container-fluid bg-secondary ">
                ...
                <div className="collapse navbar-collapse bg-secondary" id="navbarSupportedContent">
                    <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li className="nav-item">
                            <a className="nav-link" href="#">With</a>
                        </li>
                        <li className="nav-item dropdown">
                            ...
                            <ul className="dropdown-menu">
                                <li><a className="dropdown-item" href="#">By</a></li>
                                <li><a className="dropdown-item" href="#">Lucas</a></li>
                                <li><hr className="dropdown-divider" /></li>
                                <li><a className="dropdown-item" href="#">Magán</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
